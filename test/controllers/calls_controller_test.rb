...
class CallsControllerTest < ActionController::TestCase
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post :create, call: { apiURL: @call.apiURL, date: @call.date, domain: @call.domain, secret: @call.secret, type: @call.type }
    end
  ...
  test "should update call" do
    patch :update, id: @call, call: { apiURL: @call.apiURL, date: @call.date, domain: @call.domain, secret: @call.secret, type: @call.type }
    assert_redirected_to call_path(assigns(:call))
  end
